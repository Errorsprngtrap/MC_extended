...
package net.mcreator.springrami.fluid.types;
...
public class PetroleFluidType extends FluidType {
	...
	public void initializeClient(Consumer<IClientFluidTypeExtensions> consumer) {
		consumer.accept(new IClientFluidTypeExtensions() {
			private static final ResourceLocation STILL_TEXTURE = new ResourceLocation("springrami:block/petrole"), FLOWING_TEXTURE = new ResourceLocation("springrami:block/petrole");
