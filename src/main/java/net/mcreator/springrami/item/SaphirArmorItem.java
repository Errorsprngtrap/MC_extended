...
public abstract class SaphirArmorItem extends ArmorItem {
	public SaphirArmorItem(ArmorItem.Type type, Item.Properties properties) {
		super(new ArmorMaterial() {
			...
			public Ingredient getRepairIngredient() {
				return Ingredient.of(new ItemStack(SpringramiModItems.SAPHIR.get()));
			}
	...
	public static class Helmet extends SaphirArmorItem {
		...
		public String getArmorTexture(ItemStack stack, Entity entity, EquipmentSlot slot, String type) {
			return "springrami:textures/models/armor/saphir_layer_1.png";
		}
	...
	public static class Leggings extends SaphirArmorItem {
		...
		@Override
		public String getArmorTexture(ItemStack stack, Entity entity, EquipmentSlot slot, String type) {
			return "springrami:textures/models/armor/saphir_layer_2.png";
		}
